"""Seed data aligned with frontend seed.ts — in-memory initial dataset."""
...
from app.services.warranty_service import calc_warranty_status, calc_warranty_expire_date


def _w(purchase_date: str, months: int) -> dict:
    r = calc_warranty_status(purchase_date, months)
    return {"warrantyExpireDate": r.expire_date, "warrantyStatus": r.status}


HOUSEHOLD = {"id": "household_default", "name": "我的家"}
...
SEED_MANUAL_CHUNKS = [
    {
        ...
        "pageNumber": 12,
        "section": "滤芯维护",
        "content": "滤芯清洗：关闭进水阀并断开电源后，旋下滤芯外壳，取出滤芯用清水冲洗表面杂质，建议每 4 周清洗一次。请勿使用热水或腐蚀性清洁剂。",
    },
    {
        "deviceId": "dev_xiaomi_water",
        "attachmentId": "att_manual_xiaomi",
        ...
        "pageNumber": 18,
        "section": "错误代码",
        "content": "E1 表示进水异常，请检查水源是否打开、进水管是否弯折；E2 表示漏水报警，请立即关闭进水阀并联系售后。",
    },
    {
        "deviceId": "dev_xiaomi_water",
        "attachmentId": "att_manual_xiaomi",
        ...
        "pageNumber": 20,
        "section": "保养周期",
        "content": "建议每 6 个月更换一次 PP 棉滤芯，每 12 个月更换一次 RO 反渗透膜。日常使用应保持机身干燥，避免阳光直射。",
    },
]
...
SEED_FAULT_RECORDS = [
    {
        ...
        "serviceScript": "您好，我的戴森 V12 吸尘器滚刷位置有异响，吸力下降，已按建议清理滚刷缠绕毛发，问题仍存在，请问是否需要送修？",
...
SEED_AGENT_RUNS = [
    {
        ...
        "result": {
            ...
            "troubleshooting": {
                ...
                "supportMessage": "您好，我的小米净水器 S1 出现漏水，已关闭进水阀并拍照，序列号 XM-WATER-2026-0007，请问如何安排上门检测？",
                ...
                "sources": [
                    {
                        ...
                        "pageNumber": 12,
                        "section": "滤芯维护",
                        "snippet": "滤芯清洗：关闭进水阀并断开电源后，旋下滤芯外壳，取出滤芯用清水冲洗表面杂质，建议每 4 周清洗一次。",
                    },
                ],
            },
        },
    ...
    },
    {
        ...
        "result": {
            ...
            "deviceDraft": {
                ...
                "purchaseDate": "2026-06-20",
                "warrantyMonths": 24,
                "warrantyExpireDate": calc_warranty_expire_date("2026-06-20", 24),
                "serialNumber": None,
                "purchaseChannel": "小米商城",
                "confidence": 0.86,
